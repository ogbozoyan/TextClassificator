...
_ALL_USER_APIS = list(
    {lib["user_api"] for lib in _SUPPORTED_LIBRARIES.values()}
)
...
class ThreadpoolController:
    ...
    def select(self, **kwargs):
        ...
        for key, vals in kwargs.items():
            kwargs[key] = vals if isinstance(vals, list) else [vals]
...
class OpenBLASController(LibController):
    ...
    def get_version(self):
        ...
        return config[1].decode("utf-8") if config[0] == b"OpenBLAS" else None
